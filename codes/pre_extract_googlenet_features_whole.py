...
relationship_train_features=feature_dic_extractor(relationship_train_image_ids)
relationship_val_features=feature_dic_extractor(relationship_val_image_ids)
relationship_test_features=feature_dic_extractor(relationship_test_image_ids)
...
with open('../work/relationship_train_features.cpickle', 'w') as f:
    cpickle.dump(relationship_train_features,f)
with open('../work/relationship_val_features.cpickle', 'w') as f:
